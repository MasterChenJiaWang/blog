	...
	<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
		...
		<P style="position: relative;">
			...
			<INPUT id="password" name="password" class="ipt"  type="password" placeholder="请输入密码" value="${blogger.password }">   
	  		...
	  		<p   style="position: relative;">
	  		<input id="checkcode" class="c_logincode" type="text"  name="checkcode"  placeholder="请输入验证码"  value=""/>

	  		<span class="c_vcode">
			<img id="vCode" src="${pageContext.request.contextPath }/image.jsp"
								onclick="javascript:document.getElementById('loginform:vCode').src='${pageContext.request.contextPath }/image.jsp?'+Math.random();" />
	  		</span>
	  	</p>
